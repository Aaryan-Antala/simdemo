  ...
  const renderChannelItem = (channel: Channel) => {
    ...
    return (
      ...
      >
        ...
        {isChannelMember && (
          <div className="absolute right-2 top-1/2 transform -translate-y-1/2 opacity-100 group-hover:opacity-100 transition-opacity">
            <button
              ...
              className="p-2 b hover:bg-surface rounded z-10 relative"
            >
